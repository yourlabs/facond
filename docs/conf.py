# -*- coding: utf-8 -*-
#
# Django Dynamic Fields documentation build configuration file, created by
...
#html_title = u'Django Dynamic Fields v0.0.0'
...
htmlhelp_basename = 'DjangoDynamicFieldsdoc'
